...
class LongEncodingTest extends TestCase
{
    ...
    protected function skip64BitTestOn32Bit()
    {
        if (!$this->is64Bit()) {
     ...
     * @param $actual_binary
     */
    protected function assertBitShift($expected, $actual, $shift_type, $expected_binary, $actual_binary)
    {
        $this->assertEquals(
            $expected,
            $actual,
     ...
     * @param $rbin
     */
    public function testBitShift($val, $shift, $expectedLval, $expectedRval, $lbin, $rbin)
    {
     ...
     * @param $rbin
     */
    public function testLeftShiftGmp($val, $shift, $expectedLval, $expectedRval, $lbin, $rbin)
    {
        $this->skipIfNoGmp();
     ...
     * @param $rbin
     */
    public function test_right_shift_gmp($val, $shift, $expectedLval, $expectedRval, $lbin, $rbin)
    {
        $this->skipIfNoGmp();
    ...
    {
        $this->skip64BitTestOn32Bit();
        $bytes = BinaryEncoder::encodeLong($val);
    ...
    public function testDecodeLongFromArray($expectedVal, $bytes)
    {
        ...
        $val = BinaryDecoder::decodeLongFromArray($ary);
    ...
    public function testGmpDecodeLongFromArray($expectedVal, $bytes)
    {
        ...
        $val = Gmp::decodeLongFromArray($array);
        $this->assertEquals($expectedVal, $val);
    }
    ...
    public function bitShiftProvider()
    {
        ...
        return [
            ...
            ['100', 0, '100', '100', '1100100', '1100100'],
            ['100', 1, '200', '50', '11001000', '110010'],
            ['100', 7, '12800', '0', '11001000000000', '0'],
            ['100', 63, '0', '0', '0', '0'],
            ['1000000', 0, '1000000', '1000000', '11110100001001000000', '11110100001001000000'],
            ['1000000', 1, '2000000', '500000', '111101000010010000000',
                '1111010000100100000'],
